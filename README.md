...
```bash
curl -O https://raw.githubusercontent.com/higorcamposs/pokemon-mcp-server/v0.1.2/compose.ghcr.yaml
...
| Forma | Quando usar |
| --- | --- |
| `:0.1.2` | **recomendado.** Versão explícita: você sabe o que está rodando e nada muda sozinho. Uma tag de versão publicada nunca é regravada. |
